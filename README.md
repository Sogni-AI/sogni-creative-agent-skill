...
| `--expand-prompt`, `--no-expand-prompt` | Enable Alibaba prompt expansion for direct Wan 3 video, or preserve the exact submitted prompt |
...
- **Wan 3.0 Enhanced** (`wan3.0-spicy-video`; aliases `wan3-enhanced`, `wan3-spicy`) is Mulerouter-powered with fixed 30 fps, fixed 2–30 s output, native audio, 480P/720P/1080P, and `16:9`, `9:16`, `1:1`, `4:3`, or `3:4`. It accepts first/optional last frames together with up to 10 image, 5 video, and 5 audio references. It has no adaptive ratio, smart duration, document/web context, watermark, provider prompt expansion, negative prompt, source-video edit, or extend mode. Standard PAYG is $0.0845/$0.169/$0.338 per output second at 480P/720P/1080P (as of 2026-08). Existing paid subscribers receive a one-time $10 Unlimited / $20 Unlimited Pro model credit through September 1, 2026 00:00 UTC (August 31 at 5:00 PM PT); this is a launch credit, not subscription coverage.
