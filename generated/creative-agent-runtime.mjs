...
const PROMPT_CONTRACTS = [
    ...
    },
    {
        ...
        "parameterDocs": {
            ...
            "controlMode": "Pick from intent: detailer for enhance, seedance-v2v for explicit Seedance V2V, canny/depth/pose for control-net restyles, animate-move/replace for WAN Animate, outpaint to extend/expand the canvas, inpaint to regenerate a masked region.",
            "sourceImageIndex": "Required for animate-move and animate-replace. Ignored by canny, depth, detailer, outpaint, and inpaint.",
            "videoModel": "Usually omit. Use wan-animate-2 only for an explicit Wan Animate 2 animate-move request; existing WAN 2.2 remains the default.",
            "posePrompt": "Wan Animate 2 only. Optional separate prompt for pose and camera-motion conditioning.",
            "poseStrength": "Wan Animate 2 only. Pose-video conditioning strength from 0 to 10.",
            "poseStartPercent": "Wan Animate 2 only. Pose-conditioning start fraction from 0 to 1.",
            "poseEndPercent": "Wan Animate 2 only. Pose-conditioning end fraction from 0 to 1; must not precede poseStartPercent.",
            "referenceImageStrength": "Wan Animate 2 only. Identity/reference-image conditioning strength from 0 to 10.",
            "enableContextWindow": "Wan Animate 2 only. Optional official 21-frame/8-overlap temporal context-window path. Default false; leave disabled for full-sequence release quality.",
