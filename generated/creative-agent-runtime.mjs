...
const PROMPT_CONTRACTS = [
    ...
    },
    {
        ...
        "parameterDocs": {
            ...
            "voiceSourceIndex": "Which audio holds the voice to clone, same numbering as other tools use for audio: -1 is the first upload, -2 the second, and 0-based non-negative indices address audio generated earlier. Required for model=\"clone\".",
