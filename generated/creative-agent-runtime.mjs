...
const PROMPT_CONTRACTS = [
    ...
    },
    {
        ...
        "parameterDocs": {
            ...
            "destination_model": "Optional destination model selector, such as seedance2, ltx25, ltx23, wan22, flux2, gpt-image-2, or sdxl.",
    ...
    },
    {
        ...
        "parameterDocs": {
            ...
            "destination_models": "Optional preferred image/video/music model selectors (e.g. flux2, ltx25, ltx23). Each subkey is optional.",
