...
| [`video_editing`](./video_editing.md) | `animate_photo`, `sound_to_video`, `video_to_video`, `upscale_video`, `stitch_video`, `orbit_video`, `dance_montage`, `extend_video`, `replace_video_segment`, `overlay_video`, `add_subtitles` |
