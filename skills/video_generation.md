...
description: Text-to-video synthesis with LTX-2.3, WAN 2.2, Wan 3, Wan 3.0 Enhanced, Seedance, HappyHorse, and MiniMax H3.
always_loaded: false
tool_names:
  - generate_video
---
...
Text-to-video synthesis with LTX-2.3, WAN 2.2, Wan 3, Wan 3.0 Enhanced, Seedance, HappyHorse, and MiniMax H3. Use when the user wants a new video clip generated from a prompt or a loose multimodal reference set.
...
- Wan 3.0 Enhanced (`wan3.0-spicy-video`, aliases `wan3-enhanced`/`wan3-spicy`) is Mulerouter-powered: fixed 2-30 s at 30 fps, native audio, 480P/720P/1080P, and fixed ratios. Frame anchors may be combined with up to 10 image, 5 video, and 5 audio references. It has no smart duration, adaptive ratio, document/web context, watermark, provider prompt expansion, negative prompt, source-video edit, or extend mode.
