...
- Wan 3.0 Enhanced (`wan3.0-spicy-video`, MuleRouter provider ID `w3.0-video`, aliases `wan3-enhanced`/`wan3-spicy`) supports fixed or smart 2-30 s at 30 fps, native audio, prompt expansion, 480P/720P/1080P, and adaptive/fixed ratios. Use either first/last-frame anchors or up to 10 image, 5 video, and 5 audio loose references; never mix the modes. It has no document/web context, watermark, negative prompt, source-video edit, or extend mode.
